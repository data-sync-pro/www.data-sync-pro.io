...
export const FaqComponentRegistry: Record<string, any> = {
  ...
  'general-five-dsp-engines': GeneralFiveDspEnginesComponent,
  'general-no-code-rules-transform': GeneralNoCodeRulesTransformComponent,
  'general-why-dsp': GeneralWhyDspComponent,
  'general-dsp-external-data': GeneralDspExternalDataComponent,
  'general-dsp-security-privacy': GeneralDspSecurityPrivacyComponent,
  'general-dsp-licensing-pricing': GeneralDspLicensingPricingComponent,
  'general-three-user-personas': GeneralThreeUserPersonasComponent,
  'general-dsp-rules-engines-compare': GeneralDspRulesEnginesCompareComponent,
  'general-dsp-training-needed': GeneralDspTrainingNeededComponent,
  'general-dsp-adheres-sdlc': GeneralDspAdheresSdlcComponent,
  'general-dsp-governor-limits': GeneralDspGovernorLimitsComponent,

  // --- Rules Engines > Batch
  'rules-engines-batch-what-is-batch-job': RulesEnginesBatchWhatIsBatchJobComponent,
  'rules-engines-batch-why-dsp-batch': RulesEnginesBatchWhyDspBatchComponent,
  'rules-engines-batch-batch-technologies-used': RulesEnginesBatchBatchTechnologiesUsedComponent,
  'rules-engines-batch-batch-use-cases': RulesEnginesBatchBatchUseCasesComponent,
  'rules-engines-batch-batch-large-volumes': RulesEnginesBatchBatchLargeVolumesComponent,
  'rules-engines-batch-create-batch-executable': RulesEnginesBatchCreateBatchExecutableComponent,
  'rules-engines-batch-batch-cross-org': RulesEnginesBatchBatchCrossOrgComponent,
  'rules-engines-batch-batch-permissions-needed': RulesEnginesBatchBatchPermissionsNeededComponent,
  'rules-engines-batch-batch-max-dataset': RulesEnginesBatchBatchMaxDatasetComponent,
  'rules-engines-batch-batch-max-size': RulesEnginesBatchBatchMaxSizeComponent,
  'rules-engines-batch-chain-batch-executables': RulesEnginesBatchChainBatchExecutablesComponent,
  'rules-engines-batch-schedule-batch-jobs': RulesEnginesBatchScheduleBatchJobsComponent,
  'rules-engines-batch-stop-pipeline-on-fail': RulesEnginesBatchStopPipelineOnFailComponent,
  'rules-engines-batch-common-soql-pipeline': RulesEnginesBatchCommonSoqlPipelineComponent,
  'rules-engines-batch-batch-parent-child': RulesEnginesBatchBatchParentChildComponent,
  'rules-engines-batch-batch-logs-tracked': RulesEnginesBatchBatchLogsTrackedComponent,
  'rules-engines-batch-re-execute-failed-batches': RulesEnginesBatchReExecuteFailedBatchesComponent,
  'rules-engines-batch-revert-batch-changes': RulesEnginesBatchRevertBatchChangesComponent,
  'rules-engines-batch-delta-retrieval': RulesEnginesBatchDeltaRetrievalComponent,
  'rules-engines-batch-bulk-api-considerations': RulesEnginesBatchBulkApiConsiderationsComponent,
  'rules-engines-batch-batch-notifications': RulesEnginesBatchBatchNotificationsComponent,
  'rules-engines-batch-test-batch-with-sample': RulesEnginesBatchTestBatchWithSampleComponent,
  'rules-engines-batch-break-down-complex-batch': RulesEnginesBatchBreakDownComplexBatchComponent,
  'rules-engines-batch-blank-update-batch-advantages': RulesEnginesBatchBlankUpdateBatchAdvantagesComponent,

  // --- Rules Engines > Data List
  'rules-engines-data-list-what-is-data-list': RulesEnginesDataListWhatIsDataListComponent,
  'rules-engines-data-list-why-dsp-data-list': RulesEnginesDataListWhyDspDataListComponent,
  'rules-engines-data-list-create-actionable-data-list': RulesEnginesDataListCreateActionableDataListComponent,
  'rules-engines-data-list-two-components-data-list': RulesEnginesDataListTwoComponentsDataListComponent,
  'rules-engines-data-list-data-list-min-reqs': RulesEnginesDataListDataListMinReqsComponent,
  'rules-engines-data-list-actionable-vs-nonactionable': RulesEnginesDataListActionableVsNonactionableComponent,
  'rules-engines-data-list-data-list-permissions': RulesEnginesDataListDataListPermissionsComponent,
  'rules-engines-data-list-embed-data-lists-lightning': RulesEnginesDataListEmbedDataListsLightningComponent,
  'rules-engines-data-list-customize-action-ui': RulesEnginesDataListCustomizeActionUiComponent,
  'rules-engines-data-list-action-confirmation-prompt': RulesEnginesDataListActionConfirmationPromptComponent,
  'rules-engines-data-list-specify-action-scope': RulesEnginesDataListSpecifyActionScopeComponent,
  'rules-engines-data-list-review-edit-transformed': RulesEnginesDataListReviewEditTransformedComponent,
  'rules-engines-data-list-group-data-lists': RulesEnginesDataListGroupDataListsComponent,
  'rules-engines-data-list-consolidate-data-list-actions': RulesEnginesDataListConsolidateDataListActionsComponent,
  'rules-engines-data-list-specify-related-lists': RulesEnginesDataListSpecifyRelatedListsComponent,
  'rules-engines-data-list-replace-new-record': RulesEnginesDataListReplaceNewRecordComponent,
  'rules-engines-data-list-data-loader-list-action': RulesEnginesDataListDataLoaderListActionComponent,
  'rules-engines-data-list-data-list-query-permissions': RulesEnginesDataListDataListQueryPermissionsComponent,
  'rules-engines-data-list-open-record-in-lightning': RulesEnginesDataListOpenRecordInLightningComponent,
  'rules-engines-data-list-end-user-query-customization': RulesEnginesDataListEndUserQueryCustomizationComponent,
  'rules-engines-data-list-extend-data-lists-lwc': RulesEnginesDataListExtendDataListsLwcComponent,
  'rules-engines-data-list-horizontal-scrolling-data-list': RulesEnginesDataListHorizontalScrollingDataListComponent,
  'rules-engines-data-list-remote-org-data-list': RulesEnginesDataListRemoteOrgDataListComponent,

  // --- Rules Engines > Action Button
  'rules-engines-action-button-what-is-action-button': RulesEnginesActionButtonWhatIsActionButtonComponent,
  'rules-engines-action-button-why-dsp-action-button': RulesEnginesActionButtonWhyDspActionButtonComponent,
  'rules-engines-action-button-create-action-button': RulesEnginesActionButtonCreateActionButtonComponent,
  'rules-engines-action-button-customize-action-ui': RulesEnginesActionButtonCustomizeActionUiComponent,
  'rules-engines-action-button-action-confirmation-prompt': RulesEnginesActionButtonActionConfirmationPromptComponent,
  'rules-engines-action-button-display-transformed-values': RulesEnginesActionButtonDisplayTransformedValuesComponent,
  'rules-engines-action-button-group-action-buttons': RulesEnginesActionButtonGroupActionButtonsComponent,
  'rules-engines-action-button-series-actions-one-click': RulesEnginesActionButtonSeriesActionsOneClickComponent,
  'rules-engines-action-button-action-button-access': RulesEnginesActionButtonActionButtonAccessComponent,

  // --- Rules Engines > Data Loader
  'rules-engines-data-loader-data-loader-overview': RulesEnginesDataLoaderDataLoaderOverviewComponent,
  'rules-engines-data-loader-create-data-loader': RulesEnginesDataLoaderCreateDataLoaderComponent,
  'rules-engines-data-loader-load-data-different-org': RulesEnginesDataLoaderLoadDataDifferentOrgComponent,
  'rules-engines-data-loader-data-loader-logs': RulesEnginesDataLoaderDataLoaderLogsComponent,
  'rules-engines-data-loader-data-loader-type-conversion': RulesEnginesDataLoaderDataLoaderTypeConversionComponent,
  'rules-engines-data-loader-data-loader-access': RulesEnginesDataLoaderDataLoaderAccessComponent,
  'rules-engines-data-loader-data-loader-csv-only': RulesEnginesDataLoaderDataLoaderCsvOnlyComponent,
  'rules-engines-data-loader-serial-mode-usage': RulesEnginesDataLoaderSerialModeUsageComponent,
  'rules-engines-data-loader-re-execute-failed-load': RulesEnginesDataLoaderReExecuteFailedLoadComponent,
  'rules-engines-data-loader-revert-data-load': RulesEnginesDataLoaderRevertDataLoadComponent,
  'rules-engines-data-loader-fail-on-missing-column': RulesEnginesDataLoaderFailOnMissingColumnComponent,
  'rules-engines-data-loader-loader-as-list-action': RulesEnginesDataLoaderLoaderAsListActionComponent,

  // --- Rules Engines > Triggers
  'rules-engines-triggers-trigger-rules-engine': RulesEnginesTriggersTriggerRulesEngineComponent,
  'rules-engines-triggers-why-dsp-trigger': RulesEnginesTriggersWhyDspTriggerComponent,
  'rules-engines-triggers-trigger-events-supported': RulesEnginesTriggersTriggerEventsSupportedComponent,
  'rules-engines-triggers-self-adaptive-trigger': RulesEnginesTriggersSelfAdaptiveTriggerComponent,
  'rules-engines-triggers-setup-self-adaptive-trigger': RulesEnginesTriggersSetupSelfAdaptiveTriggerComponent,
  'rules-engines-triggers-aggregation-self-adaptive': RulesEnginesTriggersAggregationSelfAdaptiveComponent,
  'rules-engines-triggers-validation-self-adaptive': RulesEnginesTriggersValidationSelfAdaptiveComponent,
  'rules-engines-triggers-what-is-trigger-action': RulesEnginesTriggersWhatIsTriggerActionComponent,
  'rules-engines-triggers-setup-trigger-action': RulesEnginesTriggersSetupTriggerActionComponent,
  'rules-engines-triggers-dsp-trigger-flow': RulesEnginesTriggersDspTriggerFlowComponent,
  'rules-engines-triggers-recursive-update-triggers': RulesEnginesTriggersRecursiveUpdateTriggersComponent,
  'rules-engines-triggers-trigger-execution-order': RulesEnginesTriggersTriggerExecutionOrderComponent,
  'rules-engines-triggers-trigger-access': RulesEnginesTriggersTriggerAccessComponent,
  ...
  'process-steps-match-upsert-match-process': ProcessStepsMatchUpsertMatchProcessComponent,
  'process-steps-match-multi-field-match': ProcessStepsMatchMultiFieldMatchComponent,
  'process-steps-match-multiple-source-same-target': ProcessStepsMatchMultipleSourceSameTargetComponent,
  'process-steps-match-match-merge-principal': ProcessStepsMatchMatchMergePrincipalComponent,
  'process-steps-match-relational-field-match': ProcessStepsMatchRelationalFieldMatchComponent,
  ...
  'process-steps-mapping-sequence-of-transformations': ProcessStepsMappingSequenceOfTransformationsComponent,
  'process-steps-mapping-add-default-button': ProcessStepsMappingAddDefaultButtonComponent,
  'process-steps-mapping-clear-mappings-button': ProcessStepsMappingClearMappingsButtonComponent,
  'process-steps-mapping-unmapped-source-fields-button': ProcessStepsMappingUnmappedSourceFieldsButtonComponent,
  ...
  'process-steps-action-implement-delta-update': ProcessStepsActionImplementDeltaUpdateComponent,
  'process-steps-action-skip-update-if-exists': ProcessStepsActionSkipUpdateIfExistsComponent,
  'process-steps-action-skip-update-if-blank': ProcessStepsActionSkipUpdateIfBlankComponent,
  'process-steps-action-source-object-writeback': ProcessStepsActionSourceObjectWritebackComponent,
  'process-steps-action-use-upsert-api-field': ProcessStepsActionUseUpsertApiFieldComponent,
  ...
  // --- Transformation
  'transformation-bulkified-transformation-essential': TransformationBulkifiedTransformationEssentialComponent,
  'transformation-formula-data-types': TransformationFormulaDataTypesComponent,
  'transformation-formula-usage': TransformationFormulaUsageComponent,
  'transformation-nested-formulas': TransformationNestedFormulasComponent,
  'transformation-dsp-relationship-management': TransformationDspRelationshipManagementComponent,
  'transformation-optimize-vlookup-agg': TransformationOptimizeVlookupAggComponent,
  'transformation-handle-complex-transformations': TransformationHandleComplexTransformationsComponent,
  'transformation-define-reusable-formula': TransformationDefineReusableFormulaComponent,
  'transformation-join-source-data': TransformationJoinSourceDataComponent,
  'transformation-perform-data-masking': TransformationPerformDataMaskingComponent,
  'transformation-skip-field-if-blank': TransformationSkipFieldIfBlankComponent,
  'transformation-eliminate-duplicate-source': TransformationEliminateDuplicateSourceComponent,
  'transformation-evaluate-expressions-apex': TransformationEvaluateExpressionsApexComponent,
  'transformation-dynamic-string-format': TransformationDynamicStringFormatComponent,

  // --- Query Manager (Q)
  'query-managerq-what-is-query-manager': QueryManagerqWhatIsQueryManagerComponent,
  'query-managerq-who-can-access-q': QueryManagerqWhoCanAccessQComponent,
  'query-managerq-query-builder-construction': QueryManagerqQueryBuilderConstructionComponent,
  'query-managerq-query-execution-result': QueryManagerqQueryExecutionResultComponent,
  'query-managerq-column-filter': QueryManagerqColumnFilterComponent,
  'query-managerq-dynamic-filter': QueryManagerqDynamicFilterComponent,
  'query-managerq-query-owner-polymorphic': QueryManagerqQueryOwnerPolymorphicComponent,
  'query-managerq-query-remote-org': QueryManagerqQueryRemoteOrgComponent,
  'query-managerq-include-deleted-records': QueryManagerqIncludeDeletedRecordsComponent,
  'query-managerq-restore-deleted-records': QueryManagerqRestoreDeletedRecordsComponent,
  'query-managerq-hyperlinks-query-results': QueryManagerqHyperlinksQueryResultsComponent,
  'query-managerq-pagination-handling': QueryManagerqPaginationHandlingComponent,
  'query-managerq-q-tooling-api': QueryManagerqQToolingApiComponent,
  'query-managerq-manage-queries': QueryManagerqManageQueriesComponent,
  'query-managerq-integrate-q-lightning': QueryManagerqIntegrateQLightningComponent,
};
